                ...
                <div class="col-sm-12">
                    <div class="middel-top">
                        <div class="left floatleft">
                            <p class="text-white"><i class="mdi mdi-clock"></i> T2 - CN : 08:00 - 21:30</p>
                        </div>
                    </div>
                    <div class="middel-top clearfix">
                        <ul class="clearfix right floatright">
                            <li>
                                <a class="text-white"><i class="mdi mdi-account " ></i></a>
                                <ul>
                        ...
                        <div class="right floatright widthfull">
                            <form action="?act=shop" method="post">
                                <button type="submit" class="text-white"><i class="mdi mdi-magnify " ></i></button>
                ...
                <div class="col-sm-8">
                    <div class="header-middel">
                        <div class="mainmenu">
                            <nav>
                                <ul>
                                    <li><a href="?act=home">Home Page</a></li>
                                    <li><a href="?act=shop">Stores</a>
                                        <ul class="magamenu">
                                            <li class="banner"></li>
                                            <?php $i = 1;
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        <?php foreach ($row as $value) { ?>
                                                            <li><a
                                                                    href="?act=shop&sp=<?= $value['MaDM'] ?>&loai=<?= $value['TenLSP'] ?>"><?= $value['TenLSP'] ?></a>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                                </li>
                            ...
                            <?php if (isset($_SESSION['sanpham'])) {
                                foreach ($_SESSION['sanpham'] as $value) { ?>
                                    <div class="sin-itme clearfix">
                                        ...
                                        <a class="cart-img" href="?act=cart"><img src="public/<?= $value['HinhAnh1'] ?>"
                                                alt="" /></a>
...
<style>
    /* Khi cuộn, cố định header-bottom */
.sticky-header {
    position: fixed;
    top: 0;
    width: 100%;
...
body.has-sticky {
    padding-top: 100px; /* Điều chỉnh theo chiều cao thực tế của header-bottom */
}

</style>
<script>
    window.addEventListener('scroll', function () {
        var headerTop = document.querySelector('.header-top-two');
        var headerBottom = document.querySelector('.header-bottom');
        var body = document.body;

        if (window.scrollY > 50) {
            headerTop.classList.add('hide-header-top');
            headerBottom.classList.add('sticky-header');
            body.classList.add('has-sticky');
        } else {
            headerTop.classList.remove('hide-header-top');
            headerBottom.classList.remove('sticky-header');
